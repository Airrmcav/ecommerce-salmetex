...
import { Stethoscope, Scale, Baby, Monitor } from "lucide-react";
...
const Banner = () => {
  ...
  return (
    <div className="relative bg-linear-to-br from-blue-900 via-blue-800 to-indigo-900 text-white overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-150 py-16">
          {/* Left Content */}
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl text-blue-100 leading-relaxed max-w-lg">
                Tecnología avanzada para profesionales de la salud. Calidad
                certificada, soporte especializado y envío inmediato.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="cursor-pointer group bg-linear-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white font-bold py-4 px-8 rounded-xl shadow-2xl hover:shadow-cyan-500/25 transition-all duration-300 transform hover:-translate-y-1 flex items-center justify-center gap-3"
              >
            ...
            <div className="flex flex-wrap gap-6 text-sm text-blue-200">
              ...
              <a
                ...
                aria-label="Enviar correo a ventas@salmetexmed.com.mx"
                className="flex items-center gap-2"
              >
          ...
          <div className="relative hidden md:block">
            ...
            <div className="relative z-10">
              <div className="bg-linear-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl p-8 border border-white/20 shadow-2xl">
                {/* Medical Equipment Visualization */}
                <div
                  className="aspect-square bg-linear-to-br from-blue-400/20 to-cyan-400/20 rounded-2xl flex items-center justify-center relative overflow-hidden"
                  role="img"
                  aria-label="Visualización de equipos médicos disponibles"
                >
                  <div className="text-center space-y-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="bg-linear-to-r from-green-400 to-emerald-400 text-white text-sm font-semibold py-2 px-4 rounded-full inline-block">
                        Stock Disponible
                      </div>
                    </div>
                  </div>
            ...
            <div className="absolute -top-8 -right-8 w-40 h-40 bg-linear-to-br from-cyan-400/20 to-blue-500/20 rounded-full blur-xl"></div>
            <div className="absolute -bottom-8 -left-8 w-32 h-32 bg-linear-to-br from-purple-400/20 to-pink-500/20 rounded-full blur-xl"></div>
          </div>
        </div>
