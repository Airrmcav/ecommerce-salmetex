      ...
      <div className="flex items-center justify-between px-0 py-1 mx-auto max-w-7xl">
        ...
        <div className="hidden lg:flex items-center gap-3 shrink-0">
          <button
            onClick={() =>
              window.open(
                "https://www.facebook.com/groups/723178883718883",
                "_blank",
              )
            }
          ...
          >
            <Heart
              strokeWidth="1"
              className={`cursor-pointer ${lovedItems.length > 0 && "fill-red-300 "}`}
            />
          </button>
        ...
        <div className="flex items-center justify-between px-0 py-1 mx-auto max-w-7xl ">
          <div className="flex items-center">
            <NavigationMenu>
              <NavigationMenuList>
                <NavigationMenuItem>
                  <NavigationMenuTrigger className="uppercase cursor-pointer bg-transparent">
                    Productos
                  </NavigationMenuTrigger>
                  <NavigationMenuContent>
                            ...
                            <div className="space-y-1">
                              {[
                                ...
                                },
                                {
                                  ...
                                  description:
                                    "Productos para la mejora, rehabilitación y equipamiento de clínicas.",
                                },
                                {
                                  href: "/imss-bienestar",
          ...
          <nav className="flex items-center gap-4 xl:gap-4 [&>button]:text-gray-700 [&>button]:hover:text-blue-600 [&>button]:font-medium [&>button]:transition-color [&>button]:duration-200 [&>button]:hover:underline [&>button]:decoration-blue-600 [&>button]:underline-offset-4 text-sm  [&>button]:uppercase [&>button]:cursor-pointer">
            <button
              onClick={() => router.push("/")}
            ...
            <button
              className="bg-emerald-900 p-1 rounded-md text-white! hover:underline hover:decoration-white"
              onClick={() => router.push("/imss-bienestar")}
              aria-label="Ir a la página de IMSS Bienestar"
            >
              IMSS Bienestar
            </button>
            <button
              className="bg-emerald-900 p-1 rounded-md text-white! hover:underline hover:decoration-white"
              onClick={() => router.push("/la-clinica-es-nuestra")}
              aria-label="Ir a la página de La Clínica es Nuestra"
            >
              La Clínica es Nuestra
            </button>
            <button
              onClick={() =>
                router.push("/categoria/todos?area=Insumos+médicos")
              }
            ...
            <button
              onClick={() =>
                router.push("/categoria/todos?area=Mobiliario+médico")
              }
