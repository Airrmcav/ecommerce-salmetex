...
const InfoProduct = (props: InfoProductProps) => {
  ...
  return (
    <div className="max-w-2xl mx-auto p-3 bg-white rounded-lg">
      ...
      {/* Categoría */}
      <div className="space-y-3 mb-0 flex justify-start gap-2">
        <div>
          <Badge
            variant="outline"
      ...
      <div className="flex gap-2 mb-0 max-w-[350px] sm:max-w-none">
        <Button
      ...
      {/* Sección Compartir */}
      <div className="my-4 max-w-[350px] sm:max-w-none">
        <div className="flex items-center justify-center gap-2 mb-3">
          ...
          <Button
            ...
            onClick={() =>
              window.open(
                `https://twitter.com/intent/tweet?url=${encodeURIComponent(window.location.href)}&text=${encodeURIComponent(`Mira este producto: ${product.productName}`)}`,
                "_blank",
              )
            }
          >
          ...
          <Button
            ...
            onClick={() =>
              window.open(
                `mailto:?subject=${encodeURIComponent(`Mira este producto: ${product.productName}`)}&body=${encodeURIComponent(`Échale un vistazo a este producto: ${window.location.href}`)}`,
                "_blank",
              )
            }
          >
