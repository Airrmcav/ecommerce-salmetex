            ...
            <div className="max-w-6xl w-full">
                ...
                <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 text-center transform animate-in fade-in-0 slide-in-from-bottom-8 duration-700">
                    ...
                    {/* <div className="grid md:grid-cols-2 gap-6 mb-8">
                        <div className="bg-blue-50 rounded-xl p-6 animate-in slide-in-from-left-4 duration-500 delay-500">
                            <div className="flex items-center justify-center mb-3">
                                <Package className="w-8 h-8 text-blue-600" />
                            </div>
                            <h3 className="font-semibold text-gray-900 mb-2">Procesando tu pedido</h3>
                            <p className="text-sm text-gray-600">
                                Nuestro equipo está preparando tu equipo médico con el mayor cuidado
                            </p>
                        </div>

                        <div className="bg-green-50 rounded-xl p-6 animate-in slide-in-from-right-4 duration-500 delay-600">
                            <div className="flex items-center justify-center mb-3">
                                <Mail className="w-8 h-8 text-green-600" />
                            </div>
                            <h3 className="font-semibold text-gray-900 mb-2">Confirmación enviada</h3>
                            <p className="text-sm text-gray-600">
                                Recibirás un correo con todos los detalles y seguimiento
                            </p>
                        </div>
                    </div> */}
