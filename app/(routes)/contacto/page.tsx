    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setSubmitResult({
                    success: false,
                    message: data.error || 'Hubo un error al enviar tu mensaje. Por favor, intenta nuevamente.'
                });
            }
        } catch (error) {
                ...
                <div className="max-w-6xl mx-auto px-6 py-8">
                    <div className="text-center">
                        ...
                        <p className="text-slate-600 text-lg max-w-2xl mx-auto">
                            Ponte en contacto con nuestro equipo de especialistas en equipos médicos
                        </p>
                    </div>
                </div>
            </header>
                ...
                <div className="grid lg:grid-cols-3 gap-12">
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white rounded-2xl shadow-lg p-8 h-fit">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-600">contacto@salmetexmed.com.mx</p>
                                    </div>
                                </div>
                            ...
                            <div className="mt-8 p-4 bg-blue-50 rounded-lg">
                                <h4 className="font-semibold text-blue-800 mb-2">Soporte Técnico 24/7</h4>
                                <p className="text-blue-700 text-sm">
                                    Para emergencias médicas y soporte técnico urgente, contáctanos las 24 horas del día.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-white rounded-2xl shadow-lg p-8">
                            <h2 className="text-2xl font-bold text-slate-800 mb-6">Envíanos tu Consulta</h2>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                {submitResult.message && (
                                    <div className={`mt-4 p-4 rounded-lg ${submitResult.success ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
                                        {submitResult.message}
                                    </div>
                                )}
