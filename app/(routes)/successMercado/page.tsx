        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 transform animate-in fade-in-0 slide-in-from-bottom-8 duration-700">
                    ...
                    <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                      ...
                      <div className="text-sm text-gray-700 space-y-1">
                        <p className="font-semibold">
                          {confirmData.shippingName}
                        </p>
                        {formatAddress(confirmData.shippingAddress)?.map(
                          (line, i) => (
                            <p key={i}>{line}</p>
                          ),
                        )}
                  ...
                  <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                    ...
                    <div className="space-y-3">
                      {confirmData.emailResults ? (
                        <>
                          <div
                            className={`flex items-center justify-between p-3 rounded-lg border ${confirmData.emailResults.ventas.sent ? "bg-green-50 border-green-200" : "bg-yellow-50 border-yellow-200"}`}
                          >
                          ...
                          <div
                            className={`flex items-center justify-between p-3 rounded-lg border ${confirmData.emailResults.cliente.sent ? "bg-green-50 border-green-200" : "bg-yellow-50 border-yellow-200"}`}
                          >
                            <div className="flex items-center gap-3">
                              ...
                              <div className="text-left">
                                ...
                                <p className="text-gray-500 text-xs">
                                  {confirmData.customerEmail || "No disponible"}
                                </p>
                              </div>
                            </div>
                            <span
                            ...
                            confirmData.customerEmail && (
                              <div className="flex items-start gap-2 mt-2 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                                ...
                                <p className="text-xs text-blue-700">
                                  La información de tu pedido se ha enviado a{" "}
          ...
          <div className="bg-gradient-to-r from-blue-600 to-green-600 rounded-xl p-6 mb-8 mt-8 text-white animate-in fade-in-0 duration-500 delay-700">
            ...
            <p className="text-blue-100 text-sm">
              Tu salud y la de tus pacientes es nuestra prioridad. Esperamos
              seguir siendo tu aliado en el cuidado médico.
            </p>
          </div>
