    ...
    <div className="space-y-8">
      ...
      <div className="space-y-6">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-muted-foreground">
            Productos especializados para el programa IMSS Bienestar
          </p>
        </div>
        ...
        {/* MOBILE FILTERS */}
        {mobileFiltersOpen && (
          <div className="lg:hidden p-4 border rounded-lg space-y-4 bg-slate-50">
            <FilterArea
              onFilterChange={setFilterArea}
              value={filterArea}
            />
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          ...
          <p className="text-muted-foreground">
            No hay productos disponibles con los
