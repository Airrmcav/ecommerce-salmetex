...
export default function CarritoClient() {
  ...
  const buyStripe = async () => {
    try {
      ...
      const stripeLoader = await loadStripe();
        ...
        {items.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-gray-600 mb-8 max-w-md">
              Descubre nuestra amplia selección de equipos médicos de alta
              calidad
            </p>
            <Button
              size="lg"
              ...
              <div className="sticky top-8">
                <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <Button
                        className="w-full cursor-pointer bg-blue-600 hover:bg-blue-700 text-white py-8 text-lg font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200"
                        onClick={buyStripe}
                      ...
                      <Button
                        className="w-full cursor-pointer bg-amber-500 hover:bg-amber-600 text-white py-8 text-lg font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200"
                    ...
                    <div className="mt-6 space-y-3 text-sm text-gray-600">
                      ...
                      <div className="flex items-center">
                        ...
                        <span>Envío gratuito en pedidos médicos</span>
                      </div>
                      <div className="flex items-center">
