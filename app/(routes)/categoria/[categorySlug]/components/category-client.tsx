...
export default function CategoryClient({
  ...
  const [filterArea, setFilterAreaState] = useState(
  ...
  const fetchProducts = useCallback(
    async (area: string, category: string) => {
      setLoading(true);
      try {
        let url = "";
        if (area && category) {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-blue-50/30">
      ...
      <div className="max-w-7xl py-2 mx-auto px-5 sm:p-0">
        <header className="mb-3">
          <div className="flex items-center gap-4 mb-2">
            ...
            <div className="flex-1">
              ...
              <p className="text-md sm:text-lg text-gray-600 leading-relaxed max-w-3xl py-3">
                {categorySlug === "todos" ? (
                  <>
                    Descubre nuestra completa selección de equipos médicos de
                    alta calidad. Tecnología certificada, calidad garantizada y
                    soporte técnico especializado.
                  </>
                ) : (
                  <>
                    Descubre nuestra selección de equipos médicos especializados
                    en <strong>{categoryName.toLowerCase()}</strong>. Tecnología
                    certificada, calidad garantizada y soporte técnico
                    especializado.
                  </>
                )}
              </p>
              ...
              {!loading && displayedProducts.length === 0 && (
                <div className="col-span-full text-center py-12">
                  ...
                  <p className="text-gray-500 max-w-md mx-auto">
                    No hay productos disponibles en esta categoría. Intenta
                    ajustar los filtros o revisa otras categorías.
                  </p>
                </div>
              )}
            </div>
