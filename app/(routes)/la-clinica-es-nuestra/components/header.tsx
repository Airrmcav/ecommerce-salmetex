...
export default function Header() {
  return (
    <div className="relative mb-8 pb-8 border-b border-gray-200">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-blue-50 via-white to-blue-50 opacity-50 rounded-lg" />
      <div className="relative flex items-center gap-8 px-6">
        ...
        <div className="flex-1 text-left">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-3 leading-tight">
            Proveedor de Equipamiento Médico para
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            ...
            e insumos especializados para unidades médicas del programa La
            Clínica es Nuestra en todo el territorio nacional.
          </p>
        </div>
      </div>
    </div>
